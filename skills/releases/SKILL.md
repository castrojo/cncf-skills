...
release cadence, supported versions, end-to-end release steps, artifact signing, and
...
Do NOT use when:
- Project is a specification or documentation-only project with no compiled artifacts —
  adapt the document to describe the specification publication process instead
