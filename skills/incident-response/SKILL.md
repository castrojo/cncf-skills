...
triaging, remediating, and disclosing a confirmed security vulnerability.
...
7. **Cross-link to the security self-assessment** (see security-self-assessment skill)
   under Remediation or Post-Incident Review.
